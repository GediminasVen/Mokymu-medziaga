...
async function checkIfPersonCanDrive(age) {
  return new Promise((resolve, reject) => {
    if (age == undefined || age == null) {
      ...
      reject(`Amzius privalo buti skaicius, jusu ivesta reiksme = ${age}`);
    } else if (age < 18) {
...
checkIfPersonCanDrive()
  .then((response) => console.log(response))
  .catch((error) => console.error(error));

checkIfPersonCanDrive(22)
  .then((response) => console.log(response))
  .catch((error) => console.error(error));

checkIfPersonCanDrive(5)
  .then((response) => console.log(response))
  .catch((error) => console.error(error));

checkIfPersonCanDrive("Jonauskas")
  .then((response) => console.log(response))
  .catch((error) => console.error(error));
